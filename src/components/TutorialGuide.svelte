...
<div class="max-w-2xl mx-auto">
  ...
  <div class="mb-8">
    <div class="flex justify-between items-center mb-2">
      <h2 class="text-lg font-bold text-gray-900">Paso {currentStep + 1} de {totalSteps}</h2>
      <span class="text-sm text-gray-600">{Math.round(((currentStep + 1) / totalSteps) * 100)}%</span>
    </div>
  ...
  <div class="glass p-8 rounded-xl mb-8">
    <h3 class="text-2xl font-bold text-gray-900 mb-2">{stepTitle}</h3>
