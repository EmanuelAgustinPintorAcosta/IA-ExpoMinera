export const tutorialCatalog = {
    ...
    canva: {
        ...
        steps: [
            ...
            },
            {
                ...
                description: "En la barra de búsqueda escribí: 'Presentación escolar' o 'Clase primaria'. Canva mostrará muchas plantillas listas para usar.",
                tip: "Tip: Elegí diseños simples y coloridos para captar mejor la atención en primaria.",
                image: "/Canva.png",
            },
            {
                title: "Editar textos e imágenes",
                description: "Hacé clic sobre cualquier texto para cambiarlo. Podés seleccionar imágenes y reemplazarlas desde el panel Elementos.",
            ...
            },
            {
                ...
                description: "Presioná '+ Agregar página' para sumar nuevas hojas. Podés crear páginas con actividades como Verdadero o Falso.",
                tip: "Tip: Alterná explicación con actividades para mantener la atención del grupo.",
                image: "/Canva.png",
            },
            {
                title: "Usar herramientas con IA",
                description: "En el menú lateral buscá opciones de IA como generación de texto o imágenes para crear portadas o consignas divertidas.",
    ...
    perplexity: {
        ...
        steps: [
            {
                title: "Ingresar e iniciar sesión",
                description: "Entrá a la página oficial de Perplexity y presioná el botón Iniciar sesión ubicado en la parte superior derecha.",
            ...
            },
            {
                ...
                description: "Hacé clic en la barra y escribí una consulta educativa completa, por ejemplo: 'Actividades para enseñar el ciclo del agua en primaria'.",
            ...
            },
            {
                ...
                description: "En pocos segundos aparecerá una respuesta organizada con fuentes utilizadas. Podés hacer clic en ellas para ampliar información.",
                tip: "Tip: Revisá siempre las fuentes antes de llevar la información al aula.",
                image: "/perplexity.png",
            },
            {
                title: "Mejorar la planificación",
            ...
            },
            {
                ...
                description: "Si necesitás una clase lista para usar, escribí: 'Armame una clase de 40 minutos sobre el sistema solar para primaria'.",
...
export type TutorialCatalogKey = keyof typeof tutorialCatalog;
export type TutorialContainer = typeof tutorialCatalog[TutorialCatalogKey];
export type TutorialStep = TutorialContainer["steps"][number];
